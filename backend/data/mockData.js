...
const initialUsers = [
  {
    ...
    passwordHash: '$2a$10$w8T.Z.V3qR5s7j1x0Y1u.e3s.1b2c3d4e5f6g7h8i9j0', // bcrypt for 'admin123'
    role: 'admin',
  ...
  },
  {
    ...
    passwordHash: '$2a$10$w8T.Z.V3qR5s7j1x0Y1u.e3s.1b2c3d4e5f6g7h8i9j0',
    role: 'user',
...
const initialOrders = [
  ...
  },
  {
    ...
    shippingAddress: {
      ...
      address: '12-B Green Park Avenue',
      city: 'Mumbai',
      postalCode: '400001',
      country: 'India',
      phone: '+91 9123456789'
